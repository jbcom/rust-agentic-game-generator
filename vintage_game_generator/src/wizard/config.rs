...
"#,
    ...
    pub fn add_conversation(&mut self, role: &str, content: &str, phase: &str) {
        self.ai_context.conversation_history.push(ConversationEntry {
...
impl ConfigManager {
    ...
    pub fn set_language(&mut self, language: &str) -> Result<()> {
        ...
        self.config.wizard_state.completed_steps.push("language".to_string());
    ...
    pub fn set_wizard_mode(&mut self, mode: &str) -> Result<()> {
        ...
        self.config.wizard_state.completed_steps.push("mode_selection".to_string());
        self.save()
    }
