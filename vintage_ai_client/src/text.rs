    ...
    pub fn for_game_description() -> Self {
        Self {
            ...
            system_prompt: Some(
                ...
                gaming while feeling fresh and exciting.".to_string()
            ),
            ..Default::default()
        }
    }
    ...
    pub fn for_dialogue() -> Self {
        Self {
            ...
            system_prompt: Some(
                ...
                16-bit era text boxes. Keep responses concise but impactful.".to_string()
            ),
            ..Default::default()
        }
    }
    ...
    pub fn for_code_generation() -> Self {
        Self {
            ...
            system_prompt: Some(
                ...
                while using modern best practices. Focus on clarity and performance.".to_string()
            ),
            ..Default::default()
        }
    }
    ...
    pub fn for_world_building() -> Self {
        Self {
            ...
            system_prompt: Some(
                ...
                inspiration from classic game worlds while adding unique twists.".to_string()
            ),
            ..Default::default()
        }
    }
...
impl TextGenerator {
    ...
    pub async fn generate(&self, prompt: &str, config: TextConfig) -> Result<String> {
        ...
        let cache_key = self.cache.lock().await.generate_key("text", prompt, &params);
    ...
    pub async fn generate_structured<T: for<'de> Deserialize<'de>>(
        ...
        serde_json::from_str(cleaned)
            .context("Failed to parse structured output")
    }
...
pub mod game_content {
    ...
    pub async fn generate_game_concept(
        ...
        generator.generate_structured(&prompt, TextConfig::for_game_description()).await
    }
    ...
    pub async fn generate_character_backstory(
        ...
        generator.generate(&prompt, TextConfig::for_world_building()).await
    }
    ...
    impl TextTemplate {
        ...
        pub async fn fill(
            ...
            for var in &self.variables {
                ...
                let value = generator.generate(&prompt, TextConfig {
                    max_tokens: 50,
                    temperature: 0.7,
                    ..Default::default()
                }).await?;
